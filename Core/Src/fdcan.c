...
//
//            // Print do ID
//            sprintf(buff, "ID: 0x%lX | DLC: %ld | Data: ", canRxHeader.Identifier, canRxHeader.DataLength >> 16);
//            disp(buff);
//
//            // Print dos dados
//            for (int i = 0; i < (canRxHeader.DataLength >> 16); i++)
//            {
//            	sprintf(buff, "%02X ", canRxData[i]);
//                disp(buff);
//            }
//
//            printf("\r\n");
